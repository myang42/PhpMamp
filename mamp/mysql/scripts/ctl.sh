...
MYSQL_PIDFILE=/goinfre/myang/php/mamp/mysql/data/mysqld.pid

MYSQL_START="/goinfre/myang/php/mamp/mysql/bin/mysqld_safe --defaults-file=/goinfre/myang/php/mamp/mysql/my.cnf --mysqld=mysqld.bin --socket=/goinfre/myang/php/mamp/mysql/tmp/mysql.sock  --datadir=/goinfre/myang/php/mamp/mysql/data --log-error=/goinfre/myang/php/mamp/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
