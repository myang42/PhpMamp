...
HTTPD_PIDFILE=/goinfre/myang/php/mamp/apache2/logs/httpd.pid


HTTPD="/goinfre/myang/php/mamp/apache2/bin/httpd -f /goinfre/myang/php/mamp/apache2/conf/httpd.conf"
...
. /goinfre/myang/php/mamp/apache2/bin/envvars
