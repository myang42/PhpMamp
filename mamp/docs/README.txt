...
/goinfre/myang/php/mamp/apache2/htdocs
...
You should copy the "demo" folder into the /goinfre/myang/php/mamp/apps 
folder and add the following line at the end of the
/goinfre/myang/php/mamp/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "/goinfre/myang/php/mamp/apps/demo/conf/httpd-prefix.conf"
...
configuration in the "/goinfre/myang/php/mamp/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "/goinfre/myang/php/mamp/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"/goinfre/myang/php/mamp/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "/goinfre/myang/php/mamp/apps/demo/conf/httpd-vhosts.conf"
